...
use codetwo_core::scene::{Pipeline, Scene, SceneLibrary, SceneSource};
use codetwo_core::scene_artifact::SceneArtifactStore;
use codetwo_core::skill::{Skill, SkillKind, SkillPayload, SlotDef};
...
struct SceneInfo {
    ...
    keywords: Vec<String>,
    has_brief: bool,
    localizations: std::collections::HashMap<String, codetwo_core::scene::SceneLocalization>,
    execution: Option<codetwo_core::scene::SceneExecution>,
    brief: Option<codetwo_core::scene::SceneBrief>,
    artifacts: Vec<codetwo_core::scene::SceneArtifactSpec>,
    skills: Option<codetwo_core::scene::SceneSkills>,
    exit: Option<codetwo_core::scene::SceneExit>,
}

impl SceneInfo {
    fn from_resolved(entry: &codetwo_core::scene::ResolvedScene) -> Self {
    ...
    fn from_skill(skill: &Skill) -> SkillInfo {
        ...
        SkillInfo {
            ...
            source: skill
                .source
                .clone()
                .or_else(|| codetwo_core::harness::source_label(&skill.id).map(str::to_string)),
            macro_template,
            macro_slots,
        }
    }
...
impl Plugin for SkillsPlugin {
    ...
    async fn apply(&self, ctx: Context, _config: Value) -> PluginResult {
        ...
        ctx.command("skills.propose_macro", move |args| async move {
            ...
            let (template, slots) = codetwo_core::skill::propose_macro_slots(&args.text);
    ...
    async fn apply(&self, ctx: Context, _config: Value) -> PluginResult {
        ...
        ctx.command("scenes.export_skill_md", move |args| {
            ...
            async move {
                ...
                json(codetwo_core::scene::export_skill_md(&entry.scene))
            }
        })?;
...
fn editable_scene_dir(
    ...
    match scope {
        SceneSaveScope::User => codetwo_core::provider::home_dir()
