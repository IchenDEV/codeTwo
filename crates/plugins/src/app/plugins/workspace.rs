...
//! state, and every one of its thirteen commands is a two-line call into [`codetwo_core::git`] — yet
...
use codetwo_core::git;
use codetwo_core::keymap::Action;
...
impl Plugin for MarketPlugin {
    ...
    async fn apply(&self, ctx: Context, _config: Value) -> PluginResult {
                    ...
                    codetwo_core::market::builtin_catalog()
                        ...
                        .map(|entry| MarketItem {
                            ...
                            kind: match entry.kind() {
                                codetwo_core::skill::SkillKind::Fragment => "fragment",
                                codetwo_core::skill::SkillKind::AgentSkill => "agent_skill",
                                codetwo_core::skill::SkillKind::Subagent => "subagent",
                                codetwo_core::skill::SkillKind::Mcp => "mcp",
                                codetwo_core::skill::SkillKind::Macro => "macro",
                            },
                            id: entry.id,
                            name: entry.name,
        ...
        ctx.command("market.parse", |args| async move {
            ...
            json(codetwo_core::market::parse_catalog(&args.json).map_err(PluginError::new)?)
        })?;
        Ok(())
    }
}
