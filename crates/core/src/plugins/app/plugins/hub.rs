...
use crate::plugins::app::events::PluginsChanged;
use crate::plugins::app::plugins::plugin_development;
use crate::plugins::app::service::{LoaderService, Paths, PluginHub};
use crate::plugins::app::{json, take_args, PluginChangeRequest, PluginManager, PluginScope};
use crate::plugins::bundle as plugin;
use crate::plugins::bundle::{InstalledPlugin, PluginCounts, PluginScaffold};
use crate::plugins::marketplace::{self as plugin_marketplace, MarketplacePluginSource};
...
struct ScopedPluginCatalog {
    scope: PluginScope,
    catalog: crate::plugins::app::PluginCatalog,
}

fn effective_bundle_state(
    bundle: &PluginInfo,
    catalog: &crate::plugins::app::PluginCatalog,
) -> crate::plugins::app::plugin_manager::EffectivePluginState {
    use crate::plugins::app::plugin_manager::EffectivePluginState;
    let runtime = catalog
        .plugins
        .iter()
    ...
    let mut state = runtime
        ...
        .unwrap_or_else(|| EffectivePluginState {
            ...
            state: if bundle.enabled {
                crate::plugins::app::PluginOverride::Enabled
            } else {
                crate::plugins::app::PluginOverride::Disabled
            },
...
mod tests {
    ...
    use crate::plugins::bundle::PluginConnectorContribution;
