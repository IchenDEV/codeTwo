...
use crate::plugins::app::service::{TerminalEvent, TerminalService};
use crate::plugins::app::TerminalOutputEvent;
use crate::plugins::app::{json, take_args};
use crate::plugins::app::{PluginManager, ProjectActivityLease};
...
mod tests {
    ...
    async fn project_terminal_publish_crosses_service_isolation_on_typed_bus() {
        ...
        let project_context = app
            .ctx()
            .with_command_realm(crate::kernel::CommandRealm::project("/projects/alpha"))
            .isolate(&["terminal"]);
        ...
        assert_eq!(
            ...
            &[(
                (crate::kernel::CommandRealm::project("/projects/alpha")),
