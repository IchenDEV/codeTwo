...
//! reaches them by type ([`Context::get::<Db>()`](crate::kernel::Context::get)), with the name carried on
...
pub struct ServiceInfo {
    ...
    /// [`Context::isolate`](crate::kernel::Context::isolate).
    pub realm: u64,
    /// The scope that provided it — i.e. what unloading would take away with it.
    pub provider: crate::kernel::runtime::ScopeId,
