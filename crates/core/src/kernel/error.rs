...
//! its scope goes [`crate::kernel::Status::Failed`] and the rest of the graph keeps running.

use crate::kernel::command::CommandRealm;
use std::fmt;
...
/// Whatever went wrong inside [`crate::kernel::Plugin::apply`] or a command handler.
///
