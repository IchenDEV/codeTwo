...
//! - **JSON events** ([`Context::emit_json`](crate::kernel::Context::emit_json)) for everything that is not
...
/// [`Context::on_json`](crate::kernel::Context::on_json).
#[derive(Debug, Clone)]
...
pub(crate) struct ListenerEntry {
    pub scope: crate::kernel::runtime::ScopeId,
    pub seq: u64,
