...
Everything below `docs/archive/` is retained for provenance, implementation archaeology, or dated
research. Archived files do not describe the current product contract and must not be used as an
implementation specification without rechecking the live source and a current document under
`docs/`.
