...
[`docs/reference/plugins.md`](plugins.md) defines C2's internal runtime-module graph, but a Rust host can only
...
`crates/core/src/plugins/app/plugins/extensions.rs`.
