...
Status: **current implementation guide**. Normative external bundle and wire contracts remain in
[`plugin-standard.md`](plugin-standard.md) and [`plugin-protocol.md`](plugin-protocol.md).
...
[`docs/reference/plugin-protocol.md`](plugin-protocol.md) for the spec and a working plugin in forty lines.
...
- **Installed bundle** (`codetwo_plugins::bundle::InstalledPlugin`) — a package users install from
  ...
  definitions, scenes, and scaffolds. See `docs/reference/architecture.md`.
