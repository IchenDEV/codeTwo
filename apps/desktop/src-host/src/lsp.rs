...
use codetwo_core::plugins::events::PluginsChanged;
use codetwo_core::plugins::Paths;
...
fn lsp_start(
    ...
    if plugins_dir.is_dir() {
        let plugins = codetwo_core::plugins::bundle::load_dir(&plugins_dir).unwrap_or_default();
