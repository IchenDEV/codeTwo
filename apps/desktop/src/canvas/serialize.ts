...
const DATA_URL_RE = /^data:[^;,]+(?:;[^;,]+)*;base64,[a-z0-9+/=\s]+$/iu;
const INLINE_DATA_URL_RE =
  /data:[^;,\s]+(?:;[^;,\s]+)*;base64,[a-z0-9+/=\s]+/giu;
const HTTP_URL_RE = /^(?:https?:|javascript:|data:|blob:)/iu;
...
function normalizeAssetRefs(
  ...
  existing: readonly CanvasAssetRef[]
