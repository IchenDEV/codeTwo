...
export function TerminalPanel({
  ...
  return (
    ...
    >
      {finding && (
        <div className="mb-1 flex items-center gap-1 rounded-md bg-[var(--term-bg)] px-2 py-1.5 ring-1 ring-white/10">
          <input
            autoFocus
            value={query}
            ...
            className="min-w-0 flex-1 bg-transparent text-fine text-white/80 outline-none placeholder:text-white/35"
          />
...
function FindButton({
  ...
  return (
    <button
      ...
      title={title}
      onClick={onClick}
      className="rounded p-0.5 text-white/60 hover:bg-white/10 hover:text-white/90"
    >
      {children}
    </button>
  );
