...
export const en = {
  ...
  "pluginHub.description": "Install complete packages with Skills, Subagents, MCP servers, and project scaffolds.",
  ...
  "pluginHub.githubHint": "Reads .codex-plugin or .claude-plugin manifests and conventional folders. Installation never runs repository scripts; only install plugins you trust.",
...
export const zhCN: Record<StringKey, string> = {
  ...
  "pluginHub.title": "Plugin Hub",
  "pluginHub.description": "安装包含 Skills、Subagents、MCP 服务和项目脚手架的完整插件包。",
  ...
  "pluginHub.githubHint": "支持 .codex-plugin、.claude-plugin 清单及约定目录。安装时不会执行仓库脚本；请只安装可信插件。",
