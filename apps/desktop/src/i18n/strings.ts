...
export const en = {
  ...
  "palette.preview": "Session search preview",
  "palette.readOnlyPreview": "Read-only preview",
  ...
  "taskboard.closeInspectorDrawer": "Close inspector and return to Task list",
  ...
  "taskboard.promptFailed": "The prompt could not be staged. Your draft is still here.",
  "taskboard.transcript.title": "Recent transcript",
  "taskboard.transcript.loading": "Loading transcript…",
  "taskboard.transcript.failed": "The transcript preview is unavailable.",
  "taskboard.transcript.empty": "No durable transcript text yet.",
  "taskboard.transcript.you": "You",
  "taskboard.transcript.agent": "Agent",
  "taskboard.attention.actionRequired": "Action required",
  "taskboard.answerNotAccepted": "The request changed before Core accepted that answer. Your draft is still here.",
  "taskboard.answerFailed": "Core could not accept that answer. Your draft is still here.",
  "taskboard.forkFromPreview": "Fork from preview",
  "taskboard.splitRight": "Split right",
  "taskboard.splitBelow": "Split below",
  "taskboard.keyboardHints": "Task list keyboard shortcuts",
  "taskboard.keyboard.select": "Select",
  "taskboard.keyboard.preview": "Preview",
  "taskboard.keyboard.open": "Open",
  ...
  "taskboard.attentionEmpty": "Nothing needs your attention",
...
export const zhCN: Record<StringKey, string> = {
  ...
  "palette.current": "当前",
  "palette.preview": "Session 搜索预览",
  "palette.readOnlyPreview": "只读预览",
  ...
  "taskboard.closeInspectorDrawer": "关闭检查器并返回任务列表",
  ...
  "taskboard.promptFailed": "无法暂存这条提示；你的草稿仍保留在这里。",
  "taskboard.transcript.title": "最近对话",
  "taskboard.transcript.loading": "正在加载对话…",
  "taskboard.transcript.failed": "暂时无法预览对话。",
  "taskboard.transcript.empty": "还没有可预览的持久化对话文本。",
  "taskboard.transcript.you": "你",
  "taskboard.transcript.agent": "Agent",
  "taskboard.attention.actionRequired": "需要你操作",
  "taskboard.answerNotAccepted": "在 Core 接受前，请求已发生变化；你的草稿仍保留在这里。",
  "taskboard.answerFailed": "Core 无法接受这个答案；你的草稿仍保留在这里。",
  "taskboard.forkFromPreview": "从预览分叉",
  "taskboard.splitRight": "向右分屏",
  "taskboard.splitBelow": "向下分屏",
  "taskboard.keyboardHints": "任务列表键盘快捷键",
  "taskboard.keyboard.select": "选择",
  "taskboard.keyboard.preview": "预览",
  "taskboard.keyboard.open": "打开",
  ...
  "taskboard.attentionEmpty": "当前没有需要你处理的任务",
  "taskboard.cardAction": "{action}：{title}",
