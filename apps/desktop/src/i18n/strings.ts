...
export const en = {
  ...
  "turn.copy": "Copy",
  "turn.worked": "Worked {duration}",
  "turn.thoughtProcess": "Thinking",
  "turn.toolsRead": "Read {count} files",
  "turn.toolsEdit": "Edited {count} files",
  "turn.toolsExecute": "Ran {count} commands",
  "turn.toolsSearch": "Searched {count} patterns",
  "turn.toolsFetch": "Fetched {count} pages",
  "turn.toolsDelete": "Deleted {count} files",
  "turn.toolsMove": "Moved {count} files",
  "turn.toolsGeneric": "Used {count} tools",
  "changes.title": "{count} files changed",
  "diff.expandLines": "Show {count} more lines",
  "notices.title": "{count} notifications",
  "notices.dismiss": "Dismiss",
  "notices.justNow": "just now",
  "notices.minutesAgo": "{count}m ago",
  "notices.hoursAgo": "{count}h ago",
  "notices.sessionFailed": "Session {title} failed",
  "notices.sessionDone": "Session {title} finished",
  "notices.sessionWarning": "Session warning",
  "notices.automationAttention": "Automation {name} needs attention",
  "notices.automationFailed": "Automation {name} failed",
...
export const zhCN: Record<StringKey, string> = {
  ...
  "turn.showLess": "收起",
  "turn.copy": "复制",
  "turn.worked": "已工作 {duration}",
  "turn.thoughtProcess": "思考过程",
  "turn.toolsRead": "读取了 {count} 个文件",
  "turn.toolsEdit": "编辑了 {count} 个文件",
  "turn.toolsExecute": "运行了 {count} 条命令",
  "turn.toolsSearch": "搜索了 {count} 个模式",
  "turn.toolsFetch": "抓取了 {count} 个页面",
  "turn.toolsDelete": "删除了 {count} 个文件",
  "turn.toolsMove": "移动了 {count} 个文件",
  "turn.toolsGeneric": "调用了 {count} 个工具",
  "changes.title": "{count} 个文件已修改",
  "diff.expandLines": "展开其余 {count} 行",
  "notices.title": "{count} 条通知",
  "notices.dismiss": "忽略",
  "notices.justNow": "刚刚",
  "notices.minutesAgo": "{count} 分钟前",
  "notices.hoursAgo": "{count} 小时前",
  "notices.sessionFailed": "会话 {title} 出错了",
  "notices.sessionDone": "会话 {title} 已完成",
  "notices.sessionWarning": "会话警告",
  "notices.automationAttention": "自动化任务 {name} 需要关注",
  "notices.automationFailed": "自动化任务 {name} 失败",
