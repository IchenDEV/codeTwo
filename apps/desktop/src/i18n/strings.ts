...
export const en = {
  ...
  "settings.browserUseHint": "Choose the external browser-control backend attached to each provider. OpenAI Browser / Chrome is discovered from the installed Codex plugins; other MCP brands come from host-tools.json.",
...
export const zhCN: Record<StringKey, string> = {
  ...
  "settings.browserUse": "Browser Use",
  "settings.browserUseHint": "为每个供应商选择要挂载的外部浏览器控制后端。OpenAI Browser / Chrome 从已安装的 Codex 插件中发现；其他 MCP 品牌从 host-tools.json 读取。",
