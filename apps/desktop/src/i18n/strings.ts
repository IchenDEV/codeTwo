...
export const en = {
  ...
  "issueFlow.credentialHint": "Saved in the system credential store. Never added to prompts or repository files.",
  ...
  "issueFlow.selectIssue": "Select an issue or resume an existing development task.",
  ...
  "issueFlow.validationHint": "These commands run in the isolated task worktree after development. Review them before starting.",
  "issueFlow.allowPush": "Allow pushing this task branch",
  "issueFlow.allowPr": "Allow creating the linked pull request",
  "issueFlow.allowWriteback": "Allow milestone comments and the selected status update",
  "issueFlow.doneState": "After the PR is merged",
  "issueFlow.nativeState": "Keep status unchanged / use existing GitHub automation",
  "issueFlow.startHint": "Creates an isolated task and commits locally. External operations follow the permissions above. Merge and release remain governed by repository rules.",
  ...
  "issueFlow.requirementsChanged": "The issue changed after development started. Review the update before continuing.",
  ...
  "git.next.reason.checking": "Refreshing local Git and forge state before suggesting an action.",
  "git.next.reason.notRepository": "The current workspace is not a Git repository.",
  "git.next.reason.localChanges": "{count} changed files need review before remote state.",
  "git.next.reason.ahead": "{count} local commits have not been pushed.",
  "git.next.reason.createChangeRequest": "This task worktree has no open {label}.",
  "git.next.reason.conflicts": "The open change request reports merge conflicts.",
  "git.next.reason.failedChecks": "{count} checks failed on the open change request.",
  "git.next.reason.requestedChanges": "Reviewers requested changes.",
  "git.next.reason.pendingChecks": "{count} checks are still running.",
  "git.next.reason.behind": "The branch is {count} commits behind its upstream.",
  "git.next.reason.draft": "The change request is still a draft.",
  "git.next.reason.awaitingReview": "The change request is waiting for required review.",
  "git.next.reason.mergeReady": "Local work is clean and the change request can advance to merge.",
  "git.next.reason.merged": "The change request is merged; the task worktree can be removed after confirmation.",
  "git.next.reason.closed": "The change request is closed without a merge.",
  "git.next.reason.pullRequest": "Open the change request to inspect its current state.",
  "git.next.reason.forgeDegraded": "Local Git is available, but forge state could not be refreshed.",
  "git.next.reason.clean": "No local or remote Git action is currently required.",
  ...
  "taskboard.workspaceDescription": "Plan, execute, and track work with Sessions. Each Session owns at most one current pull request.",
  ...
  "taskboard.relationshipDescription": "A Task keeps the intent and owns Session history. Each Session owns its checkout and can resolve at most one current pull request.",
...
export const zhCN: Record<StringKey, string> = {
  ...
  "issueFlow.validationHint": "开发结束后，将在独立任务 worktree 中执行这些命令。开始前请检查。",
  ...
  "issueFlow.startHint": "创建独立任务并在本地提交。外部操作遵循以上授权；合并和发布仍遵循仓库规则。",
  ...
  "taskboard.workspaceDescription": "通过 Session 规划、执行并跟踪工作；每个 Session 最多对应一个当前 pull request。",
  ...
  "taskboard.relationshipDescription": "Task 保存目标并拥有 Session 历史；每个 Session 拥有自己的检出目录，并且最多解析出一个当前 pull request。",
