...
export const en = {
  ...
  "settings.pets": "Pets",
  "settings.petsHint":
    "Choose how your companion appears and responds while you work.",
  "settings.petPicker": "Pick a pet",
  "settings.petPickerHint": "Pets follow the active session and surface what needs attention.",
  ...
  "settings.petSizeHint": "Set how much room the pet takes below the conversation.",
...
export const zhCN: Record<StringKey, string> = {
  ...
  "settings.pets": "宠物",
  "settings.petsHint": "设置工作时宠物的显示方式与状态反馈。",
  "settings.petPicker": "选择宠物",
  "settings.petPickerHint": "宠物会跟随当前会话，并提示需要关注的状态。",
  "settings.petName": "奈娃",
  ...
  "settings.petSizeHint": "调整宠物在对话下方占用的空间。",
