...
export const en = {
  ...
  "usage.scannedTranscripts":
    "Scanned {count} transcripts. Set CODETWO_LIMIT_5H / _WEEK / _MONTH to show percentages.",
...
export const zhCN: Record<StringKey, string> = {
  ...
  "usage.scannedTranscripts": "已扫描 {count} 份会话记录。设置 CODETWO_LIMIT_5H / _WEEK / _MONTH 可显示百分比。",
