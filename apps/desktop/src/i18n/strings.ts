...
export const en = {
  ...
  "quota.unsupported": "{provider} does not expose a safe machine-readable quota interface that Code2 supports yet.",
  "quota.cliNotFound": "The {provider} CLI is not installed or is not visible to Code2.",
  "quota.queryFailed": "Code2 could not read {provider}'s quota. Check that the provider is signed in, then refresh.",
...
export const zhCN: Record<StringKey, string> = {
  ...
  "quota.unsupported": "{provider} 尚未提供 Code2 可安全读取的机器接口。",
  "quota.cliNotFound": "未安装 {provider} CLI，或 Code2 无法在 PATH 中找到它。",
  "quota.queryFailed": "Code2 无法读取 {provider} 的额度。请确认已登录该 Provider 后重试。",
