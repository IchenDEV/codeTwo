 ...
 */
export const en = {
  "issueFlow.retryCreation": "Retry task creation",
  "issueFlow.connection": "Issue tracker connection",
  "issueFlow.apiKey": "API key",
  "issueFlow.credentialHint":
    "Saved in the system credential store. Never added to prompts or repository files.",
  "issueFlow.connect": "Connect",
  "issueFlow.disconnect": "Disconnect",
  "issueFlow.open": "Issue development",
  "issueFlow.working": "Working…",
  "issueFlow.search": "Search issues or paste a Linear URL",
  "issueFlow.searchButton": "Search",
  "issueFlow.team": "Team",
  "issueFlow.allTeams": "All teams",
  "issueFlow.mine": "Assigned to me",
  "issueFlow.more": "Load more",
  "issueFlow.recent": "Development history",
  "issueFlow.selectIssue":
    "Select an issue or resume an existing development task.",
  "issueFlow.context": "Description, comments and attachments",
  "issueFlow.repository": "Repository",
  "issueFlow.provider": "Agent provider",
  "issueFlow.base": "Base: current checkout branch",
  "issueFlow.acceptance": "Acceptance criteria",
  "issueFlow.validation": "Validation commands (one per line)",
  "issueFlow.validationHint":
    "These commands run in the isolated task worktree after development. Review them before starting.",
  "issueFlow.allowPush": "Allow pushing this task branch",
  "issueFlow.allowPr": "Allow creating the linked pull request",
  "issueFlow.allowWriteback":
    "Allow milestone comments and the selected status update",
  "issueFlow.doneState": "After the PR is merged",
  "issueFlow.nativeState":
    "Keep status unchanged / use existing GitHub automation",
  "issueFlow.startHint":
    "Creates an isolated task and commits locally. External operations follow the permissions above. Merge and release remain governed by repository rules.",
  "issueFlow.start": "Start development",
  "issueFlow.creating": "Creating task",
  "issueFlow.developing": "Developing",
  "issueFlow.verifying": "Validating",
  "issueFlow.verified": "Validation passed",
  "issueFlow.review": "Awaiting review",
  "issueFlow.blocked": "Needs attention",
  "issueFlow.merged": "PR merged",
  "issueFlow.closed": "PR closed without merge",
  "issueFlow.cancelled": "Cancelled",
  "issueFlow.syncPending": "Sync pending",
  "issueFlow.syncError": "Tracker sync needs attention.",
  "issueFlow.validationResults": "Validation results",
  "issueFlow.pass": "Passed",
  "issueFlow.fail": "Failed",
  "issueFlow.openTask": "Open task",
  "issueFlow.refresh": "Refresh / retry sync",
  "issueFlow.cancel": "Cancel development",
  "issueFlow.requirementsChanged":
    "The issue changed after development started. Review the update before continuing.",
  "issueFlow.changedContext": "Updated requirements",
  "issueFlow.acceptChanges": "Accept the updated requirements",
  "issueFlow.clarification": "Clarification or continuation instructions",
  "issueFlow.continue": "Continue in the same task",
  "issueFlow.newAttempt": "Start a new attempt",
  ...
  "automations.rerun": "Run again",
  "automations.rerunStarted": "Replaying that run.",
  "automations.rerunFailed": "Could not replay the run: {error}",
  "automations.alertFailed": "Automation failed: {name}",
  "automations.alertNeedsAttention": "Automation needs attention: {name}",
  ...
  "git.next.reviewFailedChecks": "Review failed checks",
  "git.next.addressReview": "Address review",
  "git.next.viewChecks": "View checks",
  "git.next.reviewRemoteUpdates": "Review remote updates",
  "git.next.reviewDraft": "Review draft",
  "git.next.viewChangeRequest": "View {label}",
  "git.next.mergeChangeRequest": "Review & merge {label}",
  "git.next.cleanupWorktree": "Clean up worktree",
  "git.next.reason.checking":
    "Refreshing local Git and forge state before suggesting an action.",
  "git.next.reason.notRepository":
    "The current workspace is not a Git repository.",
  "git.next.reason.localChanges":
    "{count} changed files need review before remote state.",
  "git.next.reason.ahead": "{count} local commits have not been pushed.",
  "git.next.reason.createChangeRequest":
    "This task worktree has no open {label}.",
  "git.next.reason.conflicts":
    "The open change request reports merge conflicts.",
  "git.next.reason.failedChecks":
    "{count} checks failed on the open change request.",
  "git.next.reason.requestedChanges": "Reviewers requested changes.",
  "git.next.reason.pendingChecks": "{count} checks are still running.",
  "git.next.reason.behind":
    "The branch is {count} commits behind its upstream.",
  "git.next.reason.draft": "The change request is still a draft.",
  "git.next.reason.awaitingReview":
    "The change request is waiting for required review.",
  "git.next.reason.mergeReady":
    "Local work is clean and the change request can advance to merge.",
  "git.next.reason.merged":
    "The change request is merged; the task worktree can be removed after confirmation.",
  "git.next.reason.closed": "The change request is closed without a merge.",
  "git.next.reason.pullRequest":
    "Open the change request to inspect its current state.",
  "git.next.reason.forgeDegraded":
    "Local Git is available, but forge state could not be refreshed.",
  "git.next.reason.clean":
    "No local or remote Git action is currently required.",
  ...
  "dock.pullRequestDesc":
    "Inspect and review the pull request for this branch.",
  "dock.trajectoryDesc":
  ...
  "action.split_pane_right": "Split pane right",
  "action.split_pane_down": "Split pane down",
  "action.toggle_side_panel": "Toggle side panel",
  ...
  "taskboard.allTasks": "All tasks",
  "taskboard.workspaceDescription":
    "Plan, execute, and track work with Sessions. Each Session owns at most one current pull request.",
  "taskboard.breadcrumb": "Task board breadcrumb",
  "taskboard.titleHeader": "Title",
  "taskboard.sessionsHeader": "Sessions",
  "taskboard.openPullRequestsHeader": "Open PRs",
  "taskboard.updatedHeader": "Updated",
  "taskboard.taskList": "Task list",
  "taskboard.boardView": "Task board view",
  "taskboard.viewSwitcher": "Task view",
  ...
  "taskboard.selectSession":
    "Select Session {number}: {title}, status: {status}",
  ...
  "taskboard.openPullRequestCountPending":
    "Open pull request count is still loading",
  "taskboard.noSessions": "No Sessions",
  "taskboard.noSessionsDescription":
    "Start this Task to create its first execution Session.",
  ...
  "taskboard.noPullRequestForSession":
    "This Session's checkout has no current pull request.",
  ...
  "taskboard.recentActivity": "Recent activity",
  "taskboard.askAgent": "Ask Agent about this Session",
  "taskboard.askAgentPlaceholder": "Add a prompt and continue in this Session…",
  "taskboard.openSession": "Open Session",
  "taskboard.continueWithPrompt": "Continue with prompt",
  "taskboard.taskDetails": "Task details",
  "taskboard.noDescription": "No description",
...
export const zhCN: Record<StringKey, string> = {
  "issueFlow.retryCreation": "重试创建任务",
  "issueFlow.connection": "需求平台连接",
  "issueFlow.apiKey": "API Key",
  "issueFlow.credentialHint": "保存于系统凭据库，不会加入提示词或仓库文件。",
  "issueFlow.connect": "连接",
  "issueFlow.disconnect": "断开连接",
  "issueFlow.open": "Issue 开发",
  "issueFlow.working": "处理中…",
  "issueFlow.search": "搜索需求或粘贴 Linear 链接",
  "issueFlow.searchButton": "搜索",
  "issueFlow.team": "团队",
  "issueFlow.allTeams": "所有团队",
  "issueFlow.mine": "分配给我",
  "issueFlow.more": "加载更多",
  "issueFlow.recent": "开发记录",
  "issueFlow.selectIssue": "选择一个 Issue，或继续已有开发任务。",
  "issueFlow.context": "描述、评论与附件",
  "issueFlow.repository": "仓库",
  "issueFlow.provider": "Agent 提供方",
  "issueFlow.base": "基线：当前检出分支",
  "issueFlow.acceptance": "验收条件",
  "issueFlow.validation": "验证命令（每行一条）",
  "issueFlow.validationHint":
    "开发结束后，将在独立任务 worktree 中执行这些命令。开始前请检查。",
  "issueFlow.allowPush": "允许推送此任务分支",
  "issueFlow.allowPr": "允许创建关联 PR",
  "issueFlow.allowWriteback": "允许回写里程碑评论和所选状态",
  "issueFlow.doneState": "PR 合并后",
  "issueFlow.nativeState": "保持状态不变／沿用已有 GitHub 自动化",
  "issueFlow.startHint":
    "创建独立任务并在本地提交。外部操作遵循以上授权；合并和发布仍遵循仓库规则。",
  "issueFlow.start": "开始开发",
  "issueFlow.creating": "创建任务中",
  "issueFlow.developing": "开发中",
  "issueFlow.verifying": "验证中",
  "issueFlow.verified": "验证通过",
  "issueFlow.review": "待评审",
  "issueFlow.blocked": "需要处理",
  "issueFlow.merged": "PR 已合并",
  "issueFlow.closed": "PR 已关闭，未合并",
  "issueFlow.cancelled": "已取消",
  "issueFlow.syncPending": "待同步",
  "issueFlow.syncError": "平台同步需要处理。",
  "issueFlow.validationResults": "验证结果",
  "issueFlow.pass": "通过",
  "issueFlow.fail": "失败",
  "issueFlow.openTask": "打开任务",
  "issueFlow.refresh": "刷新／重试同步",
  "issueFlow.cancel": "取消开发",
  "issueFlow.requirementsChanged": "开发开始后需求发生变化。请检查更新后继续。",
  "issueFlow.changedContext": "更新后的需求",
  "issueFlow.acceptChanges": "接受更新后的需求",
  "issueFlow.clarification": "补充说明或继续开发的要求",
  "issueFlow.continue": "在原任务中继续",
  "issueFlow.newAttempt": "开始新一轮开发",
  ...
  "automations.rerun": "重新运行",
  "automations.rerunStarted": "已重新运行该次任务。",
  "automations.rerunFailed": "重新运行失败：{error}",
  "automations.alertFailed": "自动化运行失败：{name}",
  "automations.alertNeedsAttention": "自动化需要处理：{name}",
  ...
  "git.next.reviewFailedChecks": "查看失败检查",
  "git.next.addressReview": "处理审阅意见",
  "git.next.viewChecks": "查看检查",
  "git.next.reviewRemoteUpdates": "查看远端更新",
  "git.next.reviewDraft": "检查草稿",
  "git.next.viewChangeRequest": "查看 {label}",
  "git.next.mergeChangeRequest": "审阅并合并 {label}",
  "git.next.cleanupWorktree": "清理工作树",
  "git.next.reason.checking": "正在刷新本地 Git 与托管平台状态，再推荐下一步。",
  "git.next.reason.notRepository": "当前工作区不是 Git 仓库。",
  "git.next.reason.localChanges": "有 {count} 个改动文件，应先完成审阅。",
  "git.next.reason.ahead": "有 {count} 个本地提交尚未推送。",
  "git.next.reason.createChangeRequest": "这个任务工作树还没有开放的 {label}。",
  "git.next.reason.conflicts": "当前变更请求存在合并冲突。",
  "git.next.reason.failedChecks": "当前变更请求有 {count} 项检查失败。",
  "git.next.reason.requestedChanges": "审阅者请求了修改。",
  "git.next.reason.pendingChecks": "仍有 {count} 项检查在运行。",
  "git.next.reason.behind": "当前分支比上游落后 {count} 个提交。",
  "git.next.reason.draft": "当前变更请求仍是草稿。",
  "git.next.reason.awaitingReview": "当前变更请求正在等待必要审阅。",
  "git.next.reason.mergeReady": "本地工作树干净，当前变更请求可以进入合并。",
  "git.next.reason.merged": "变更请求已合并，确认后可以移除任务工作树。",
  "git.next.reason.closed": "变更请求已关闭但未合并。",
  "git.next.reason.pullRequest": "打开变更请求查看最新状态。",
  "git.next.reason.forgeDegraded": "本地 Git 可用，但无法刷新托管平台状态。",
  "git.next.reason.clean": "当前没有需要执行的本地或远端 Git 操作。",
  ...
  "settings.windowMotion": "窗口动效",
  "settings.windowMotionHint": "平铺布局变化时，让窗格平滑移动到新位置。",
  "settings.windowMotionInstant": "即时",
  "settings.windowMotionFast": "快速",
  "settings.windowMotionSmooth": "平滑",
  ...
  "action.split_pane_right": "向右拆分窗格",
  "action.split_pane_down": "向下拆分窗格",
  "action.toggle_side_panel": "切换侧边面板",
  ...
  "taskboard.allTasks": "全部任务",
  "taskboard.workspaceDescription":
    "通过 Session 规划、执行并跟踪工作；每个 Session 最多对应一个当前 pull request。",
  "taskboard.breadcrumb": "任务看板路径",
  "taskboard.titleHeader": "标题",
  "taskboard.sessionsHeader": "Sessions",
  "taskboard.openPullRequestsHeader": "打开的 PR",
  "taskboard.updatedHeader": "更新时间",
  "taskboard.taskList": "任务列表",
  "taskboard.boardView": "任务看板视图",
  "taskboard.viewSwitcher": "任务视图",
  "taskboard.view.list": "列表",
  ...
  "taskboard.recentActivity": "最近活动",
  "taskboard.askAgent": "询问 Agent 这个 Session",
  "taskboard.askAgentPlaceholder": "添加提示并在这个 Session 中继续…",
  "taskboard.openSession": "打开 Session",
  "taskboard.continueWithPrompt": "带提示继续",
  "taskboard.taskDetails": "任务详情",
  "taskboard.noDescription": "暂无描述",
