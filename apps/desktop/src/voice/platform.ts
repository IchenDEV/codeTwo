/**
 * WebKit can expose `webkitSpeechRecognition` inside a Tauri webview, but starting it delegates
 ...
 * therefore always goes through Code2's native, bundle-aware recording/transcription path.
 */
