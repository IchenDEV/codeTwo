...
export default function App() {
  ...
  const [composerHByPane, setComposerHByPane] = useState<
                                    ...
                                    <DropdownMenuTrigger
                                      render={
                                        <Button
                                          ...
                                          variant="link"
                                          size="compact"
                                          className="decoration-muted-foreground/40 h-auto px-0 py-0 text-inherit decoration-dotted underline-offset-[7px]"
