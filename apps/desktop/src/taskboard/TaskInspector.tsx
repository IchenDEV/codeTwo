...
import {
  ...
  TaskInspectorInsights,
} from "./TaskInspectorSummary";
...
export function TaskInspector(props: TaskInspectorProps) {
  if (!props.task) {
    return (
      <div className="text-body text-muted-foreground flex min-h-full items-center justify-center px-6 text-center">
      ...
      <div className="task-board-inspector-tabs task-board-panel-header flex shrink-0 items-start px-4 py-5">
        ...
        >
          <TabsTrigger value="agent">
            {props.t("taskboard.inspector.agent")}
          </TabsTrigger>
          <TabsTrigger value="details">
            {props.t("taskboard.inspector.details")}
          </TabsTrigger>
          <TabsTrigger value="insights">
            {props.t("taskboard.inspector.insights")}
          </TabsTrigger>
        </TabsList>
      </div>
      <Separator />
