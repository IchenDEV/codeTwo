  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "group-data-[variant=toolbar]/tabs-list:rounded-control group-data-[variant=toolbar]/tabs-list:px-module-inset group-data-[variant=toolbar]/tabs-list:text-muted-foreground group-data-[variant=toolbar]/tabs-list:hover:bg-fill-hover group-data-[variant=toolbar]/tabs-list:data-active:bg-fill-selected group-data-[variant=toolbar]/tabs-list:data-active:text-primary group-data-[variant=toolbar]/tabs-list:data-active:hover:bg-fill-selected-hover dark:group-data-[variant=toolbar]/tabs-list:data-active:bg-fill-selected group-data-[variant=toolbar]/tabs-list:h-full group-data-[variant=toolbar]/tabs-list:flex-none group-data-[variant=toolbar]/tabs-list:py-0 group-data-[variant=toolbar]/tabs-list:data-active:shadow-none",
        className
      )}
      {...props}
    />
