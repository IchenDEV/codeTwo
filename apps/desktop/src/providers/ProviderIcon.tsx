...
/**
 * Provider brand marks, keyed by the core's provider id.
 *
 * Drawn in `currentColor` rather than brand colours. At 14px in a list row five competing palettes
 * fight the text for attention, and at least one is always illegible against the current theme —
 * the source assets are literally named `-dark` and `-light`. Shape carries recognition at this
 * size; colour would only carry noise.
 */
...
*/
export const providerMarks: Record<string, (p: IconProps) => ReactNode> = {
  amp: AmpMark,
