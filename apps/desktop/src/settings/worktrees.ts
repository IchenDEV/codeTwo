...
export function worktreeBranchDisplay(branch: string | null | undefined): string | null {
...
export function worktreeStatusBadges(entry: WorktreeStatusEntry): WorktreeStatusBadge[] {
...
export function worktreeDiscardRoute(entry: WorktreeStatusEntry): WorktreeDiscardRoute {
