...
describe("Sparkle update bundle discovery", () => {
  test("finds the enclosing application from an Electrobun executable", () => {
    expect(enclosingAppBundle("/Applications/C2.app/Contents/MacOS/launcher")).toBe(
      "/Applications/C2.app",
    );
    expect(enclosingAppBundle("/Applications/C2.app/Contents/Resources/app/bun/index.js")).toBe(
      "/Applications/C2.app",
    );
    expect(enclosingAppBundle(
